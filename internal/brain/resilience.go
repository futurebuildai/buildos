...
// CircuitConfig configures the brain client's circuit breaker.
...
// circuitBreaker is the in-house breaker shared by every brain HTTP
...
// machine fits in ~80 LOC and the brain client is the only consumer.
