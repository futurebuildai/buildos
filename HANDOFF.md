...
**Next:** BYOK → AI-on capability-flip Playwright journey (the web `e2e` lane now
covers claim→wizard→portfolio AND recalc→CPM cascade-diff; the capability-flip
journey is still stubbed), plus Flutter golden tests for the offline/sync visual
states.
